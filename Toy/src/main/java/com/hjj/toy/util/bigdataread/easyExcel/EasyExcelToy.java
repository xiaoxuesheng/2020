package com.hjj.toy.util.bigdataread.easyExcel;
...
public class EasyExcelToy {
    ...
    public static void main(String[] args) throws IOException {
        String file = "奥维云网2017年7月数据.xlsx";
...
//            data = EasyExcelFactory.read(inputStream, new Sheet(1, 0));
            //-----2
//            data = EasyExcelFactory.read(inputStream, new Sheet(2, 1, ReadModel.class));
            //-----3
